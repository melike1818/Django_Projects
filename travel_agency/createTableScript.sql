...
price INT, 
PRIMARY KEY (a_id, a_date),
FOREIGN KEY (a_id, a_date) REFERENCES activity(a_id, a_date));
...
FOREIGN KEY(a_id, a_date) REFERENCES extra_activity(a_id, a_date),
FOREIGN KEY(c_id) REFERENCES customer(u_id));
...
explanation CHAR(50),
is_accepted BOOLEAN,
PRIMARY KEY(t_id,t_start_date,t_end_date,e_id,c_id, r_id),
...
PRIMARY KEY(b_id, b_start_date, b_end_date, h_id, r_number),
...
is_accepted BOOLEAN,
explanation CHAR(250),
PRIMARY KEY(f_booking_id, f_id, f_date),
FOREIGN KEY(f_id,f_date) REFERENCES flight(f_id, f_date),
FOREIGN KEY(c_id) REFERENCES customer(u_id),
FOREIGN KEY(e_id) REFERENCES employee(u_id));
...
b_start_date DATE NOT NULL,
b_end_date DATE NOT NULL,
PRIMARY KEY(r_id, b_id, b_start_date, b_end_date),
FOREIGN KEY(r_id) REFERENCES reservation(r_id),
FOREIGN KEY(b_id, b_start_date, b_end_date) REFERENCES booking(b_id, b_start_date, b_end_date));
